...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Center(
        child: SizedBox(
          // A browser window is whatever width it is; a fixed 500 px
          // card leaves a phone reading a column two words wide.
          ...
          child: Column(
            ...
            children: [
              ...
              Text(tr?.appTitle ?? 'DeroGold Web Wallet', style: Theme.of(context).textTheme.headlineMedium),
              const SizedBox(height: 4),
              Text(tr?.versionInfo(_kVersion) ?? 'Version $_kVersion — DEGO Web Wallet',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        tr?.aboutDescription ??
                        'DeroGold Web Wallet is the official browser wallet for '
                        'DeroGold (DEGO), a fast and lightweight CryptoNote-based '
                        'cryptocurrency.\n\n'
                        'Built with Flutter, powered by wallet_capi compiled to '
                        'WebAssembly.',
