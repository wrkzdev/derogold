...
abstract class S {
  ...
  /// No description provided for @sendDegoToAny.
  ///
  /// In en, this message translates to:
  /// **'Send DEGO to any address'**
  String get sendDegoToAny;
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to DeroGold Web Wallet'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Connect to a remote daemon node. Changes take effect immediately.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Save wallet to browser storage after sync and every 5 minutes'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Show a browser notification when DEGO is received'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Version {version} — DEGO Web Wallet'**
  String versionInfo(String version);

  /// No description provided for @aboutDescription.
  ///
  /// In en, this message translates to:
  /// **'DeroGold Web Wallet is the official browser wallet for DeroGold (DEGO), a fast and lightweight CryptoNote-based cryptocurrency.\n\nBuilt with Flutter, powered by wallet_capi compiled to WebAssembly.'**
  ...
  /// No description provided for @invalidDeroGoldAddress.
  ///
  /// In en, this message translates to:
  /// **'Invalid DeroGold address. Must be 97 characters (standard) or 185 (integrated), starting with "dg".'**
  String get invalidDeroGoldAddress;
  ...
  /// No description provided for @degoReceived.
  ///
  /// In en, this message translates to:
  /// **'DEGO Received'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Cannot verify the password in this browser. Use “Close wallet instead” and open the wallet again.'**
