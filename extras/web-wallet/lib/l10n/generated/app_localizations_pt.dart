...
class SPt extends S {
  ...
  @override
  String get appTitle => 'DeroGold Web Wallet';
  ...
  String get shareAddressSubtitle =>
      'Compartilhe seu endereço para receber DEGO';
  ...
  @override
  String get sendDegoToAny => 'Enviar DEGO para qualquer endereço';
  ...
  @override
  String get welcomeToDeroGold => 'Bem-vindo ao DeroGold Web Wallet';
  ...
  @override
  String get walletFile => 'Nome da carteira';
  ...
  @override
  String get nodeDescription => 'Conecte-se a um nó daemon remoto. As alterações têm efeito imediato.';
  ...
  @override
  String get saveWalletSubtitle => 'Gravar o estado atual no armazenamento do navegador';
  ...
  @override
  String get exportToJsonSubtitle => 'Baixar os dados da carteira como arquivo JSON';
  ...
  @override
  String get autosaveSubtitle => 'Salvar a carteira no armazenamento do navegador após sincronizar e a cada 5 minutos';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Mostrar uma notificação do navegador quando DEGO for recebido';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Remover definitivamente a carteira do armazenamento do navegador';

  @override
  String get deleteWalletWarning => 'Isto excluirá definitivamente a sua carteira do armazenamento deste navegador.\n\nCertifique-se de ter feito backup da frase semente e das chaves privadas antes de continuar. Esta ação não pode ser desfeita.';
  ...
  String versionInfo(String version) {
    return 'Versão $version — Carteira web DEGO';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet é a carteira de navegador oficial do DeroGold (DEGO), uma criptomoeda rápida e leve baseada em CryptoNote.\n\nConstruída com Flutter, alimentada por wallet_capi compilado para WebAssembly.';
  ...
  @override
  String get twitterXSubtitle => 'Siga @DeroGold';
  ...
  @override
  String get invalidDeroGoldAddress => 'Endereço DeroGold inválido. Deve ter 97 caracteres (padrão) ou 185 (integrado) e começar com "dg".';
  ...
  @override
  String get degoReceived => 'DEGO Recebido';
  ...
  @override
  String get derogoldWallet => 'DeroGold Web Wallet';
  ...
  @override
  String get unlockNeedsReopen => 'Não é possível verificar a senha neste navegador. Use “Fechar a carteira” e abra-a novamente.';
  ...
  @override
  String get sectionLocalNode => 'Nó leve local';

  @override
  String get localNodeDescription =>
      'Execute um nó neste computador e sincronize com ele em vez de um servidor remoto. Um nó leve guarda apenas o que uma carteira precisa, mas ainda assim transfere a cadeia inteira uma vez.';

  @override
  String get localNodeSetUp => 'Configurar nó local';

  @override
  String get localNodeStart => 'Iniciar';

  @override
  String get localNodeStop => 'Parar';

  @override
  String get localNodeUse => 'Usar este nó';

  @override
  String get localNodeDelete => 'Eliminar dados do nó';

  @override
  String get localNodeStateStopped => 'Parado';

  @override
  String get localNodeStateStarting => 'A iniciar';

  @override
  String get localNodeStateSyncing => 'A sincronizar';

  @override
  String get localNodeStateReady => 'Sincronizado';

  @override
  String get localNodeStateFailed => 'Falhou';

  @override
  String localNodeProgress(int height, int network) {
    return 'Bloco $height de $network';
  }
  ...
  String get localNodeNotReadyYet =>
      'O nó local ainda está a recuperar e não consegue servir a carteira. Continua a sincronizar em segundo plano — fique num nó remoto até estar pronto e depois mude.';

  @override
  String get localNodeInUse => 'A carteira está ligada a este nó.';

  @override
  String localNodeBinaryMissing(String name) {
    return '$name não foi encontrado. Coloque o binário do daemon junto ao executável da carteira, ou numa pasta \"sidecar\" ao lado, e tente novamente.';
  }

  @override
  String get localNodeSetupTitle => 'Configurar um nó leve local';

  @override
  String get localNodeSetupCost =>
      'Antes de começar:\n• Cerca de 6 GB de espaço em disco, e a cadeia inteira é transferida uma vez.\n• A primeira sincronização demora horas. Continua em segundo plano e pode usar um nó remoto entretanto.\n• A altura inicial abaixo é permanente. Alterá-la mais tarde implica eliminar o nó e sincronizar tudo de novo.';
  ...
  String localNodeStartHeightHelp(int height) {
    return 'Os blocos abaixo desta altura são transferidos e verificados, e só é guardado o índice de que os blocos seguintes precisam. Mantenha-a igual ou inferior à altura inicial desta carteira ($height).';
  }

  @override
  String localNodeStartHeightTooHigh(int height) {
    return 'Superior à altura inicial desta carteira ($height). O nó nunca conseguiria mostrar as transações mais antigas desta carteira.';
  }

  @override
  String get localNodeCreate => 'Criar nó';

  @override
  String get localNodeDeleteTitle => 'Eliminar os dados do nó local?';

  @override
  String get localNodeDeleteWarning =>
      'Isto para o nó e elimina permanentemente a sua base de dados da cadeia do disco. A carteira, a sua seed e os seus fundos não são afetados — mas um novo nó local voltará a sincronizar do zero, o que demora horas.';

  @override
  String get localNodeDeleted => 'Nó local eliminado.';

  @override
  String localNodeDiskUsage(String size) {
    return '$size em disco';
  }

  @override
  String get nodePresetRemote => 'Nó remoto';

  @override
  String get nodePresetLocal => 'Nó leve local';

  @override
  String get savingWallet => 'Salvando sua carteira…';

  @override
  String get savingWalletBody =>
      'O DeroGold está gravando sua carteira no disco. Isso pode demorar um pouco em uma carteira grande.';
  ...
  String get stillRunningInTray =>
      'O DeroGold continua rodando na bandeja do sistema. Clique no ícone para trazê-lo de volta, ou clique com o botão direito e escolha Sair.';
  ...
  String get nodeExitBodySyncing =>
      'A primeira sincronização dele não terminou. Isso leva horas e só avança enquanto o nó está rodando — mas um nó deixado rodando continua usando o disco e a rede depois que o DeroGold fecha.';

  @override
  String get nodeExitBodySynced =>
      'Ele está em dia com a rede. Deixá-lo rodando o mantém assim e continua usando CPU, banda e disco enquanto o DeroGold está fechado; pará-lo custa uma breve atualização na próxima vez.';
  ...
  String get localNodeStillRunningBody =>
      'O nó lite local continua rodando em segundo plano. Abra o DeroGold para pará-lo.';
