...
class SRu extends S {
  ...
  String get shareAddressSubtitle =>
      'Поделитесь своим адресом для получения DEGO';
  ...
  @override
  String get sendDegoToAny => 'Отправить DEGO на любой адрес';
  ...
  @override
  String get welcomeToDeroGold => 'Добро пожаловать в DeroGold Web Wallet';
  ...
  @override
  String get walletFile => 'Имя кошелька';
  ...
  @override
  String get nodeDescription => 'Подключение к удалённому узлу-демону. Изменения вступают в силу сразу.';
  ...
  @override
  String get saveWalletSubtitle => 'Записать текущее состояние в хранилище браузера';
  ...
  @override
  String get exportToJsonSubtitle => 'Скачать данные кошелька в виде файла JSON';
  ...
  @override
  String get autosaveSubtitle => 'Сохранять кошелёк в хранилище браузера после синхронизации и каждые 5 минут';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Показывать уведомление браузера при получении DEGO';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Безвозвратно удалить кошелёк из хранилища браузера';

  @override
  String get deleteWalletWarning => 'Кошелёк будет безвозвратно удалён из хранилища этого браузера.\n\nПеред продолжением убедитесь, что вы сохранили мнемоническую фразу и приватные ключи. Это действие нельзя отменить.';
  ...
  String versionInfo(String version) {
    return 'Версия $version — Веб-кошелёк DEGO';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet — официальный браузерный кошелёк для DeroGold (DEGO), быстрой и лёгкой криптовалюты на основе CryptoNote.\n\nСоздан на Flutter, работает на wallet_capi, скомпилированном в WebAssembly.';
  ...
  @override
  String get twitterXSubtitle => 'Подписывайтесь на @DeroGold';
  ...
  @override
  String get licenseText => 'Выпущено под лицензией GNU General Public License v3.0.\nИспользуйте на свой риск. Всегда делайте резервную копию мнемонической фразы.';
  ...
  @override
  String get invalidDeroGoldAddress => 'Недопустимый адрес DeroGold. Должен содержать 97 символов (стандартный) или 185 (интегрированный) и начинаться с «dg».';
  ...
  @override
  String get degoReceived => 'DEGO получены';
  ...
  @override
  String get unlockNeedsReopen => 'Не удаётся проверить пароль в этом браузере. Выберите «Закрыть кошелёк» и откройте его заново.';
  ...
  String get savingWalletBody =>
      'DeroGold записывает кошелёк на диск. На большом кошельке это может занять некоторое время.';
  ...
  String get stillRunningInTray =>
      'DeroGold продолжает работать в системном трее. Нажмите на значок, чтобы вернуть окно, или нажмите правой кнопкой и выберите «Выход».';
  ...
  String get nodeExitBodySyncing =>
      'Первая синхронизация не завершена. Она занимает часы и идёт только пока узел запущен — но оставленный работать узел продолжает использовать диск и сеть после закрытия DeroGold.';

  @override
  String get nodeExitBodySynced =>
      'Он на уровне сети. Если оставить его работать, он таким и останется и продолжит тратить процессор, трафик и диск, пока DeroGold закрыт; если остановить — в следующий раз потребуется короткое догоняние.';
  ...
  String get localNodeStillRunningBody =>
      'Локальный лайт-узел продолжает работать в фоне. Откройте DeroGold, чтобы его остановить.';
