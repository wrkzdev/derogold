...
class SZh extends S {
  ...
  @override
  String get shareAddressSubtitle => '分享您的地址以接收 DEGO';
  ...
  @override
  String get sendDegoToAny => '发送 DEGO 到任意地址';
  ...
  @override
  String get welcomeToDeroGold => '欢迎使用 DeroGold Web Wallet';
  ...
  @override
  String get nodeDescription => '连接到远程守护进程节点。更改立即生效。';
  ...
  @override
  String get saveWalletSubtitle => '将当前状态写入浏览器存储';
  ...
  @override
  String get exportToJsonSubtitle => '将钱包数据下载为 JSON 文件';
  ...
  @override
  String get autosaveSubtitle => '同步后以及每 5 分钟将钱包保存到浏览器存储';
  ...
  @override
  String get incomingTxAlertsSubtitle => '收到 DEGO 时显示浏览器通知';
  ...
  @override
  String get deleteWalletDataSubtitle => '从浏览器存储中永久删除钱包';

  @override
  String get deleteWalletWarning => '这将从此浏览器的存储中永久删除您的钱包。\n\n继续之前，请确保已备份助记词和私钥。此操作无法撤销。';
  ...
  String versionInfo(String version) {
    return '版本 $version — DEGO 网页钱包';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet 是 DeroGold (DEGO) 的官方网页钱包，DeroGold 是一种基于 CryptoNote 的快速轻量加密货币。\n\n使用 Flutter 构建，由编译为 WebAssembly 的 wallet_capi 驱动。';
  ...
  @override
  String get licenseText => '基于 GNU 通用公共许可证 v3.0 发布。\n使用风险自负。请务必备份您的助记词。';
  ...
  @override
  String get invalidDeroGoldAddress => '无效的 DeroGold 地址。必须以 "dg" 开头，长度为 97（标准）或 185（集成）个字符。';
  ...
  @override
  String get degoReceived => '收到 DEGO';
  ...
  @override
  String get unlockNeedsReopen => '无法在此浏览器中验证密码。请使用“改为关闭钱包”，然后重新打开钱包。';
  ...
  @override
  String get savingWalletBody => 'DeroGold 正在将钱包写入磁盘。钱包较大时可能需要一点时间。';
  ...
  @override
  String get stillRunningInTray => 'DeroGold 仍在系统托盘中运行。点击托盘图标可重新打开，或右键点击并选择“退出”。';
  ...
  String get nodeExitBodySyncing =>
      '它的首次同步尚未完成。这需要数小时，且只有节点运行时才会推进——但保持运行的节点在 DeroGold 关闭后仍会占用磁盘和网络。';

  @override
  String get nodeExitBodySynced =>
      '它已与网络同步。保持运行可以维持这一状态，但在 DeroGold 关闭期间仍会占用 CPU、带宽和磁盘；停止它则下次需要短暂追赶。';
  ...
  @override
  String get localNodeStillRunningBody => '本地轻节点仍在后台运行。打开 DeroGold 可以停止它。';
