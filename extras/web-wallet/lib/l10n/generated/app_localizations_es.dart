...
class SEs extends S {
  ...
  @override
  String get shareAddressSubtitle => 'Comparte tu dirección para recibir DEGO';
  ...
  String get integratedAddressDescription =>
      'Combina tu dirección con un ID de pago. Usa el botón aleatorio para un nuevo ID, o ingresa el tuyo abajo.';
  ...
  String get customPaymentIdLabel =>
      'ID de pago personalizado (64 caracteres hexadecimales)';
  ...
  String get enterPaymentIdError =>
      'Ingresa un ID de pago (64 caracteres hexadecimales)';
  ...
  @override
  String get sendDegoToAny => 'Enviar DEGO a cualquier dirección';
  ...
  @override
  String get welcomeToDeroGold => 'Bienvenido a DeroGold Web Wallet';
  ...
  @override
  String get walletFile => 'Nombre de la billetera';
  ...
  @override
  String get nodeDescription => 'Conéctate a un nodo daemon remoto. Los cambios se aplican de inmediato.';
  ...
  @override
  String get saveWalletSubtitle => 'Guardar el estado actual en el almacenamiento del navegador';
  ...
  @override
  String get exportToJsonSubtitle => 'Descargar los datos de la billetera como archivo JSON';
  ...
  @override
  String get autosaveSubtitle => 'Guardar la billetera en el almacenamiento del navegador tras sincronizar y cada 5 minutos';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Mostrar una notificación del navegador cuando se reciban DEGO';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Eliminar definitivamente la billetera del almacenamiento del navegador';

  @override
  String get deleteWalletWarning => 'Esto eliminará definitivamente tu billetera del almacenamiento de este navegador.\n\nAsegúrate de haber respaldado tu frase semilla y tus claves privadas antes de continuar. Esta acción no se puede deshacer.';
  ...
  String versionInfo(String version) {
    return 'Versión $version — Billetera web DEGO';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet es la billetera oficial de navegador para DeroGold (DEGO), una criptomoneda rápida y ligera basada en CryptoNote.\n\nDesarrollada con Flutter, impulsada por wallet_capi compilado a WebAssembly.';
  ...
  @override
  String get twitterXSubtitle => 'Seguir a @DeroGold';
  ...
  @override
  String get licenseText => 'Publicado bajo la Licencia Pública General de GNU v3.0.\nÚsalo bajo tu propio riesgo. Siempre respalda tu frase semilla.';
  ...
  @override
  String get invalidDeroGoldAddress => 'Dirección DeroGold inválida. Debe tener 97 caracteres (estándar) o 185 (integrada) y comenzar con "dg".';
  ...
  @override
  String get degoReceived => 'DEGO recibido';
  ...
  @override
  String get unlockNeedsReopen => 'No se puede verificar la contraseña en este navegador. Usa «Cerrar la billetera» y ábrela de nuevo.';
  ...
  String get savingWalletBody =>
      'DeroGold está escribiendo tu monedero en el disco. Puede tardar un momento en un monedero grande.';
  ...
  String get stillRunningInTray =>
      'DeroGold sigue ejecutándose en la bandeja del sistema. Haz clic en el icono para recuperarlo, o haz clic derecho y elige Salir.';
  ...
  String get nodeExitBodySyncing =>
      'Su primera sincronización no ha terminado. Tarda horas y solo avanza mientras el nodo está en marcha, pero un nodo en marcha sigue usando el disco y la red después de cerrar DeroGold.';

  @override
  String get nodeExitBodySynced =>
      'Está al día con la red. Dejarlo en marcha lo mantiene así y sigue usando CPU, ancho de banda y disco mientras DeroGold está cerrado; detenerlo cuesta una puesta al día breve la próxima vez.';
  ...
  String get localNodeStillRunningBody =>
      'El nodo lite local sigue ejecutándose en segundo plano. Abre DeroGold para detenerlo.';
