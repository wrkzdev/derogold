...
class SJa extends S {
  ...
  @override
  String get shareAddressSubtitle => 'DEGOを受け取るためにアドレスを共有してください';
  ...
  @override
  String get sendDegoToAny => '任意のアドレスにDEGOを送金';
  ...
  @override
  String get welcomeToDeroGold => 'DeroGold Web Wallet へようこそ';
  ...
  @override
  String get nodeDescription => 'リモートのデーモンノードに接続します。変更はすぐに反映されます。';
  ...
  @override
  String get saveWalletSubtitle => '現在の状態をブラウザーストレージに書き込みます';
  ...
  @override
  String get exportToJsonSubtitle => 'ウォレットデータを JSON ファイルとしてダウンロード';
  ...
  @override
  String get autosaveSubtitle => '同期後と 5 分ごとにウォレットをブラウザーストレージへ保存します';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'DEGO を受信したときにブラウザー通知を表示します';
  ...
  @override
  String get deleteWalletDataSubtitle => 'ウォレットをブラウザーストレージから完全に削除します';

  @override
  String get deleteWalletWarning => 'このブラウザーのストレージからウォレットを完全に削除します。\n\n続行する前に、シードフレーズと秘密鍵をバックアップしてください。この操作は取り消せません。';
  ...
  String versionInfo(String version) {
    return 'バージョン $version — DEGO ウェブウォレット';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet は DeroGold（DEGO）の公式ブラウザウォレットです。DEGO は高速で軽量な CryptoNote ベースの暗号通貨です。\n\nFlutter で構築され、WebAssembly にコンパイルされた wallet_capi を使用しています。';
  ...
  @override
  String get twitterXSubtitle => '@DeroGold をフォロー';
  ...
  @override
  String get licenseText => 'GNU General Public License v3.0 の下で公開されています。\n自己責任でご利用ください。シードフレーズは必ずバックアップしてください。';
  ...
  @override
  String get invalidDeroGoldAddress => '無効な DeroGold アドレスです。「dg」で始まる 97 文字（標準）または 185 文字（統合）である必要があります。';
  ...
  @override
  String get degoReceived => 'DEGOを受信しました';
  ...
  @override
  String get unlockNeedsReopen => 'このブラウザーではパスワードを確認できません。「代わりにウォレットを閉じる」を使い、ウォレットを開き直してください。';
  ...
  String get savingWalletBody =>
      'DeroGold がウォレットをディスクに書き込んでいます。大きなウォレットでは少し時間がかかることがあります。';
  ...
  String get stillRunningInTray =>
      'DeroGold は通知領域で実行中です。アイコンをクリックすると再表示できます。終了するにはアイコンを右クリックして「終了」を選択してください。';
  ...
  String get nodeExitBodySyncing =>
      '初回同期がまだ終わっていません。数時間かかり、ノードが動いている間だけ進みます。ただし実行したままにすると、DeroGold を閉じた後もディスクとネットワークを使い続けます。';

  @override
  String get nodeExitBodySynced =>
      'ネットワークに追いついています。実行したままにすればその状態を保てますが、DeroGold を閉じても CPU・帯域・ディスクを使います。停止すると次回に短い追いつきが必要です。';
  ...
  String get localNodeStillRunningBody =>
      'ローカルライトノードはバックグラウンドで実行中です。停止するには DeroGold を開いてください。';
