...
class SFr extends S {
  ...
  String get shareAddressSubtitle =>
      'Partagez votre adresse pour recevoir des DEGO';
  ...
  @override
  String get sendDegoToAny => 'Envoyer des DEGO à n\'importe quelle adresse';
  ...
  @override
  String get welcomeToDeroGold => 'Bienvenue sur DeroGold Web Wallet';
  ...
  @override
  String get walletFile => 'Nom du portefeuille';
  ...
  @override
  String get nodeDescription => 'Se connecter à un nœud daemon distant. Les modifications prennent effet immédiatement.';
  ...
  @override
  String get saveWalletSubtitle => 'Écrire l\'état actuel dans le stockage du navigateur';
  ...
  @override
  String get exportToJsonSubtitle => 'Télécharger les données du portefeuille au format JSON';
  ...
  @override
  String get autosaveSubtitle => 'Enregistrer le portefeuille dans le stockage du navigateur après la synchronisation et toutes les 5 minutes';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Afficher une notification du navigateur à la réception de DEGO';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Supprimer définitivement le portefeuille du stockage du navigateur';

  @override
  String get deleteWalletWarning => 'Cela supprimera définitivement votre portefeuille du stockage de ce navigateur.\n\nAssurez-vous d\'avoir sauvegardé votre phrase de récupération et vos clés privées avant de continuer. Cette action est irréversible.';
  ...
  String versionInfo(String version) {
    return 'Version $version — Portefeuille web DEGO';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet est le portefeuille web officiel pour DeroGold (DEGO), une cryptomonnaie rapide et légère basée sur CryptoNote.\n\nCréé avec Flutter, propulsé par wallet_capi compilé en WebAssembly.';
  ...
  @override
  String get invalidDeroGoldAddress => 'Adresse DeroGold invalide. Doit contenir 97 caractères (standard) ou 185 (intégrée) et commencer par « dg ».';
  ...
  @override
  String get degoReceived => 'DEGO reçus';
  ...
  @override
  String get unlockNeedsReopen => 'Impossible de vérifier le mot de passe dans ce navigateur. Utilisez « Fermer le portefeuille » puis rouvrez-le.';
  ...
  String get savingWalletBody =>
      'DeroGold écrit votre portefeuille sur le disque. Cela peut prendre un moment sur un gros portefeuille.';
  ...
  String get stillRunningInTray =>
      'DeroGold fonctionne toujours dans la zone de notification. Cliquez sur l\'icône pour le rouvrir, ou faites un clic droit et choisissez Quitter.';
  ...
  String get nodeExitBodySyncing =>
      'Sa première synchronisation n\'est pas terminée. Elle prend des heures et n\'avance que pendant que le nœud tourne — mais un nœud laissé en marche continue d\'utiliser le disque et le réseau après la fermeture de DeroGold.';

  @override
  String get nodeExitBodySynced =>
      'Il est à jour avec le réseau. Le laisser tourner le maintient à jour et continue d\'utiliser le processeur, la bande passante et le disque pendant que DeroGold est fermé ; l\'arrêter coûte un bref rattrapage la prochaine fois.';
  ...
  String get localNodeStillRunningBody =>
      'Le nœud allégé local fonctionne toujours en arrière-plan. Ouvrez DeroGold pour l\'arrêter.';
