...
class SVi extends S {
  ...
  @override
  String get shareAddressSubtitle => 'Chia sẻ địa chỉ của bạn để nhận DEGO';
  ...
  @override
  String get sendDegoToAny => 'Gửi DEGO đến bất kỳ địa chỉ nào';
  ...
  @override
  String get welcomeToDeroGold => 'Chào mừng đến DeroGold Web Wallet';
  ...
  @override
  String get nodeDescription => 'Kết nối tới một node daemon từ xa. Thay đổi có hiệu lực ngay lập tức.';
  ...
  @override
  String get saveWalletSubtitle => 'Ghi trạng thái hiện tại vào bộ nhớ trình duyệt';
  ...
  @override
  String get exportToJsonSubtitle => 'Tải dữ liệu ví xuống dưới dạng tệp JSON';
  ...
  @override
  String get autosaveSubtitle => 'Lưu ví vào bộ nhớ trình duyệt sau khi đồng bộ và mỗi 5 phút';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Hiển thị thông báo trình duyệt khi nhận được DEGO';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Xoá vĩnh viễn ví khỏi bộ nhớ trình duyệt';

  @override
  String get deleteWalletWarning => 'Thao tác này sẽ xoá vĩnh viễn ví của bạn khỏi bộ nhớ của trình duyệt này.\n\nHãy chắc chắn rằng bạn đã sao lưu cụm từ hạt giống và khoá riêng tư trước khi tiếp tục. Không thể hoàn tác hành động này.';
  ...
  String versionInfo(String version) {
    return 'Phiên bản $version — Ví web DEGO';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet là ví trình duyệt chính thức cho DeroGold (DEGO), một loại tiền mã hóa nhanh và nhẹ dựa trên CryptoNote.\n\nĐược xây dựng bằng Flutter, vận hành bởi wallet_capi biên dịch sang WebAssembly.';
  ...
  @override
  String get licenseText => 'Phát hành theo Giấy phép Công cộng GNU v3.0.\nSử dụng theo rủi ro của bạn. Luôn sao lưu cụm từ hạt giống.';
  ...
  @override
  String get invalidDeroGoldAddress => 'Địa chỉ DeroGold không hợp lệ. Phải có 97 ký tự (tiêu chuẩn) hoặc 185 (tích hợp) và bắt đầu bằng "dg".';
  ...
  @override
  String get degoReceived => 'Đã nhận DEGO';
  ...
  @override
  String get unlockNeedsReopen => 'Không thể xác minh mật khẩu trong trình duyệt này. Hãy dùng “Đóng ví” rồi mở lại ví.';
  ...
  String get savingWalletBody =>
      'DeroGold đang ghi ví của bạn xuống đĩa. Việc này có thể mất một lúc với ví lớn.';
  ...
  String get stillRunningInTray =>
      'DeroGold vẫn đang chạy trong khay hệ thống. Nhấp vào biểu tượng để mở lại, hoặc nhấp chuột phải và chọn Thoát.';
  ...
  String get nodeExitBodySyncing =>
      'Lần đồng bộ đầu tiên chưa xong. Việc này mất nhiều giờ và chỉ tiến triển khi nút đang chạy — nhưng một nút để chạy vẫn dùng đĩa và mạng sau khi DeroGold đóng.';

  @override
  String get nodeExitBodySynced =>
      'Nó đã ngang với mạng. Để chạy tiếp sẽ giữ như vậy và vẫn dùng CPU, băng thông và đĩa khi DeroGold đóng; dừng lại thì lần sau phải bắt kịp một chút.';
  ...
  String get localNodeStillRunningBody =>
      'Nút lite cục bộ vẫn chạy nền. Mở DeroGold để dừng nó.';
