...
class SDe extends S {
  ...
  String get shareAddressSubtitle =>
      'Teile deine Adresse, um DEGO zu empfangen';
  ...
  @override
  String get sendDegoToAny => 'DEGO an eine beliebige Adresse senden';
  ...
  @override
  String get welcomeToDeroGold => 'Willkommen bei DeroGold Web Wallet';
  ...
  @override
  String get walletFile => 'Wallet-Name';
  ...
  @override
  String get nodeDescription => 'Mit einem entfernten Daemon-Knoten verbinden. Änderungen werden sofort wirksam.';
  ...
  @override
  String get saveWalletSubtitle => 'Aktuellen Zustand in den Browser-Speicher schreiben';
  ...
  @override
  String get exportToJsonSubtitle => 'Wallet-Daten als JSON-Datei herunterladen';
  ...
  @override
  String get autosaveSubtitle => 'Wallet nach der Synchronisierung und alle 5 Minuten im Browser-Speicher sichern';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'Eine Browser-Benachrichtigung anzeigen, wenn DEGO empfangen wird';
  ...
  @override
  String get deleteWalletDataSubtitle => 'Das Wallet dauerhaft aus dem Browser-Speicher entfernen';

  @override
  String get deleteWalletWarning => 'Dies löscht dein Wallet dauerhaft aus dem Speicher dieses Browsers.\n\nStelle sicher, dass du deine Seed-Phrase und privaten Schlüssel gesichert hast, bevor du fortfährst. Diese Aktion kann nicht rückgängig gemacht werden.';
  ...
  String versionInfo(String version) {
    return 'Version $version — DEGO Web-Wallet';
  }

  @override
  String get aboutDescription => 'DeroGold Web Wallet ist das offizielle Browser-Wallet für DeroGold (DEGO), eine schnelle und leichtgewichtige CryptoNote-basierte Kryptowährung.\n\nErstellt mit Flutter, betrieben von wallet_capi als WebAssembly.';
  ...
  @override
  String get licenseText => 'Veröffentlicht unter der GNU General Public License v3.0.\nVerwendung auf eigene Gefahr. Sichere immer deine Seed-Phrase.';
  ...
  @override
  String get invalidDeroGoldAddress => 'Ungültige DeroGold-Adresse. Muss 97 Zeichen (Standard) oder 185 (integriert) lang sein und mit "dg" beginnen.';
  ...
  @override
  String get degoReceived => 'DEGO empfangen';
  ...
  @override
  String get unlockNeedsReopen => 'Das Passwort kann in diesem Browser nicht überprüft werden. Verwende „Wallet stattdessen schließen“ und öffne das Wallet erneut.';
  ...
  String get savingWalletBody =>
      'DeroGold schreibt Ihr Wallet auf die Festplatte. Bei einem großen Wallet kann das einen Moment dauern.';
  ...
  String get stillRunningInTray =>
      'DeroGold läuft weiter im Infobereich. Klicken Sie auf das Symbol, um es zurückzuholen, oder klicken Sie mit der rechten Maustaste und wählen Sie Beenden.';
  ...
  String get nodeExitBodySyncing =>
      'Seine erste Synchronisierung ist nicht fertig. Sie dauert Stunden und kommt nur voran, solange der Node läuft — ein laufender Node nutzt aber auch nach dem Schließen von DeroGold weiter Festplatte und Netzwerk.';

  @override
  String get nodeExitBodySynced =>
      'Er ist auf dem Stand des Netzwerks. Weiterlaufen zu lassen hält ihn dort und verbraucht weiter CPU, Bandbreite und Festplatte, während DeroGold geschlossen ist; ihn zu stoppen kostet beim nächsten Mal kurzes Aufholen.';
  ...
  String get localNodeStillRunningBody =>
      'Der lokale Lite-Node läuft weiter im Hintergrund. Öffnen Sie DeroGold, um ihn zu stoppen.';
