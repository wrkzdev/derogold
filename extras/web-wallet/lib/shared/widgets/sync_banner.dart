...
class _SyncBannerState extends State<SyncBanner> {
  ...
  Widget build(BuildContext context) {
    // A stalled sync is not progress. The shell's LiteNodeBanner carries the
    // daemon's own reason; a bar creeping along underneath would contradict it.
    if (widget.status.isWalletSynced || widget.status.hasSyncError) {
