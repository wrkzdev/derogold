...
class LocalNodeController extends Notifier<LocalNodeState> {
  ...
  Future<void> _init() async {
    ...
    // "Failed to create lock file: .../DB/LOCK". The pid file says whether
  ...
  void _applyInfo(Map<String, dynamic> info) {
    ...
    state = state.copyWith(
      ...
      reportedLiteStartHeight: (info['lite_node_height'] as num?)?.toInt(),
    );
  }
  ...
  Future<Map<String, dynamic>?> _probeOurNode(LocalNodeConfig config) async {
    ...
    final reported = (info['lite_node_height'] as num?)?.toInt();
