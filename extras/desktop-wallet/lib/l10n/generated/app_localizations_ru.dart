...
class SRu extends S {
  ...
  @override
  String get sendWrkzToAny => 'Отправить DEGO на любой адрес';
  ...
  @override
  String get welcomeToDeroGold => 'Добро пожаловать в DeroGold Wallet';
  ...
  String get incomingTxAlertsSubtitle =>
      'Показывать уведомление на рабочем столе при получении DEGO';
  ...
  String versionInfo(String version) {
    return 'Версия $version — Десктопный кошелёк DEGO';
  }

  @override
  String get aboutDescription =>
      'DeroGold Wallet — официальный десктопный кошелёк для DeroGold (DEGO), быстрой и лёгкой криптовалюты на основе CryptoNote.\n\nСоздан на Flutter, работает на wallet_capi.';
  ...
  @override
  String get wrkzReceived => 'DEGO получены';
  ...
  @override
  String get derogoldWallet => 'Кошелёк DeroGold';
