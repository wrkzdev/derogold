...
class SJa extends S {
  ...
  @override
  String get sendWrkzToAny => '任意のアドレスにDEGOを送金';
  ...
  @override
  String get welcomeToDeroGold => 'DeroGold Wallet へようこそ';
  ...
  @override
  String get incomingTxAlertsSubtitle => 'DEGOを受信したときにデスクトップ通知を表示';
  ...
  String versionInfo(String version) {
    return 'バージョン $version — DEGO デスクトップウォレット';
  }

  @override
  String get aboutDescription =>
      'DeroGold WalletはDeroGold（DEGO）の公式デスクトップウォレットです。DEGOは高速で軽量なCryptoNoteベースの暗号通貨です。\n\nFlutterで構築され、wallet_capiを使用しています。';
  ...
  @override
  String get wrkzReceived => 'DEGOを受信しました';
  ...
  @override
  String get derogoldWallet => 'DeroGoldウォレット';
