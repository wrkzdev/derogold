...
class SZh extends S {
  ...
  @override
  String get invalidAddress => '无效的 DEGO 地址';
  ...
  @override
  String get walletAddressHint => 'dg... 地址';
  ...
  @override
  String get degoReceived => '已收到 DEGO';
  ...
  @override
  String get feeDeductedOnSend => '在交易发送时扣除';
  ...
  String get licenseText =>
      '基于 GNU General Public License v3.0 发布。使用风险自负。请务必备份您的助记词。';

  @override
  String get slowRescanTitle => '这将花费很长时间';

  @override
  String slowRescanWarning(int height) {
    return '从低于区块 $height 处重新扫描需要遍历几乎整条链。在手机上这需要数小时不间断的工作，期间应用必须保持在前台。';
  }

  @override
  String get slowRescanContinue => '仍然重新扫描';
}
