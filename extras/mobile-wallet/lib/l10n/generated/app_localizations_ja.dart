...
class SJa extends S {
  ...
  @override
  String get invalidAddress => '無効なDEGOアドレスです';
  ...
  @override
  String get walletAddressHint => 'dg... アドレス';
  ...
  @override
  String get degoReceived => 'DEGOを受け取りました';
  ...
  @override
  String get feeDeductedOnSend => '送信時に差し引かれます';
  ...
  String versionInfo(String version) {
    return 'バージョン $version — DEGO モバイルウォレット';
  }
  ...
  String get licenseText =>
      'GNU General Public License v3.0 の下で公開されています。自己責任でご利用ください。シードフレーズは必ずバックアップしてください。';

  @override
  String get slowRescanTitle => 'これには非常に長い時間がかかります';

  @override
  String slowRescanWarning(int height) {
    return 'ブロック $height より下からの再スキャンはチェーンのほぼ全体を走査します。携帯電話では数時間かかり、その間アプリを前面に保つ必要があります。';
  }

  @override
  String get slowRescanContinue => 'それでも再スキャン';
}
