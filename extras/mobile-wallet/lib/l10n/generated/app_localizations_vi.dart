...
class SVi extends S {
  ...
  @override
  String get invalidAddress => 'Địa chỉ DEGO không hợp lệ';
  ...
  @override
  String get walletAddressHint => 'Địa chỉ dg...';
  ...
  @override
  String get feeDeductedOnSend => 'được trừ khi giao dịch được gửi';
  ...
  String versionInfo(String version) {
    return 'Phiên bản $version — Ví di động DEGO';
  }
  ...
  String get licenseText =>
      'Phát hành theo Giấy phép Công cộng GNU v3.0. Sử dụng theo rủi ro của bạn. Luôn sao lưu cụm từ hạt giống.';

  @override
  String get slowRescanTitle => 'Việc này sẽ mất rất nhiều thời gian';

  @override
  String slowRescanWarning(int height) {
    return 'Quét lại từ dưới khối $height sẽ duyệt gần như toàn bộ chuỗi. Trên điện thoại việc này mất hàng giờ liên tục, và ứng dụng phải ở phía trước trong suốt quá trình.';
  }

  @override
  String get slowRescanContinue => 'Vẫn quét lại';
}
