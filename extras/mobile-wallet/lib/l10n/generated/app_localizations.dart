...
abstract class S {
  ...
  /// Progress label while a transaction proof of work runs
  ///
  /// In en, this message translates to:
  /// **'Computing PoW... {seconds}s'**
  String computingPow(int seconds);

  /// Shown in place of a fee figure on the review step: the backend settles the fee when it builds the transaction, which is the same moment it sends it
  ///
  /// In en, this message translates to:
  /// **'deducted when the transaction is sent'**
  String get feeDeductedOnSend;

  /// Settings section header for app information and links
  ///
  /// In en, this message translates to:
  /// **'About'**
  String get about;
  ...
  ///
  /// In en, this message translates to:
  /// **'Version {version} — DEGO Mobile Wallet'**
  ...
  /// License body. GPL-3.0, matching LICENSE in this repository
  ///
  /// In en, this message translates to:
  /// **'Released under the GNU General Public License v3.0. Use at your own risk. Always back up your seed phrase.'**
  String get licenseText;

  /// Title of the confirmation before a rescan from a low height
  ///
  /// In en, this message translates to:
  /// **'This will take a very long time'**
  String get slowRescanTitle;

  /// Body of the slow-rescan confirmation
  ///
  /// In en, this message translates to:
  /// **'A rescan from below block {height} walks almost the whole chain. On a phone that is hours of uninterrupted work, and the app has to stay in the foreground while it runs.'**
  String slowRescanWarning(int height);

  /// Confirm button of the slow-rescan warning
  ///
  /// In en, this message translates to:
  /// **'Rescan anyway'**
  String get slowRescanContinue;
}
