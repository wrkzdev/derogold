...
class SFr extends S {
  ...
  String get enterCustomPaymentId =>
      'Ou entrez un identifiant de paiement personnalisé (64 hex)';
  ...
  String get paymentIdInvalid =>
      'L\'identifiant de paiement doit comporter 64 caractères hexadécimaux';
  ...
  @override
  String get mustBeHex => 'Doit comporter 64 caractères hexadécimaux';

  @override
  String get recipientRequired => 'L\'adresse du destinataire est requise';

  @override
  String get invalidAddress => 'Adresse DEGO invalide';
  ...
  @override
  String get appName => 'DeroGold Wallet';
  ...
  @override
  String get walletAddressHint => 'Adresse dg...';
  ...
  @override
  String get feeDeductedOnSend => 'déduits lors de l’envoi de la transaction';
  ...
  String versionInfo(String version) {
    return 'Version $version — Portefeuille mobile DEGO';
  }
  ...
  String get licenseText =>
      'Publié sous la licence GNU General Public License v3.0. Utilisation à vos propres risques. Sauvegardez toujours votre phrase de récupération.';

  @override
  String get slowRescanTitle => 'Cela prendra très longtemps';

  @override
  String slowRescanWarning(int height) {
    return 'Une réanalyse sous le bloc $height parcourt presque toute la chaîne. Sur un téléphone, cela représente des heures de travail ininterrompu, et l’application doit rester au premier plan.';
  }

  @override
  String get slowRescanContinue => 'Réanalyser quand même';
}
