...
class SRu extends S {
  ...
  @override
  String get invalidAddress => 'Недействительный адрес DEGO';
  ...
  @override
  String get walletAddressHint => 'dg... адрес';
  ...
  @override
  String get feeDeductedOnSend => 'списывается при отправке транзакции';
  ...
  String versionInfo(String version) {
    return 'Версия $version — Мобильный кошелёк DEGO';
  }
  ...
  String get licenseText =>
      'Выпущено под лицензией GNU General Public License v3.0. Используйте на свой риск. Всегда делайте резервную копию мнемонической фразы.';

  @override
  String get slowRescanTitle => 'Это займёт очень много времени';

  @override
  String slowRescanWarning(int height) {
    return 'Повторное сканирование ниже блока $height проходит почти всю цепочку. На телефоне это часы непрерывной работы, и приложение должно оставаться на переднем плане.';
  }

  @override
  String get slowRescanContinue => 'Всё равно сканировать';
}
