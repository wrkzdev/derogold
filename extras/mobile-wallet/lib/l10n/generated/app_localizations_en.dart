...
class SEn extends S {
  ...
  @override
  String get invalidAddress => 'Invalid DEGO address';
  ...
  @override
  String get walletAddressHint => 'dg... address';
  ...
  @override
  String get feeDeductedOnSend => 'deducted when the transaction is sent';
  ...
  @override
  String get slowRescanTitle => 'This will take a very long time';

  @override
  String slowRescanWarning(int height) {
    return 'A rescan from below block $height walks almost the whole chain. On a phone that is hours of uninterrupted work, and the app has to stay in the foreground while it runs.';
  }

  @override
  String get slowRescanContinue => 'Rescan anyway';
}
