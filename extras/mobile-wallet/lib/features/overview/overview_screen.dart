    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          statusAsync.whenOrNull(
                data: (status) {
                  // A stalled sync is not progress. The shell's LiteNodeBanner
                  // carries the reason, so don't also show a bar creeping
                  // toward a height that will never arrive.
                  if (!status.isWalletSynced && !status.hasSyncError) {
                    return Padding(
